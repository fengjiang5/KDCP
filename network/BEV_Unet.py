...
class UNet(nn.Module):
    ...
    def forward(self, x):
        x1 = self.inc(x)  # [B, 64, 480, 360]
        x2 = self.down1(x1)  # [B, 128, 240,180]  *
        x3 = self.down2(x2)  # [B, 256, 120, 90]
        x4 = self.down3(x3)  # [B, 512, 60, 45]  *
        x5 = self.down4(x4)  # [B, 512, 30, 22]  
        x_up5 = self.up1(x5, x4)  # [B, 256, 60, 45]  *
        x_up4 = self.up2(x_up5, x3)  # [B, 128, 120, 90]
        x_up3 = self.up3(x_up4, x2)  # [B, 64, 240, 180]  *
        x_up2 = self.up4(x_up3, x1)  # [B, 64, 480, 360]
        x_up1 = self.outc(self.dropout(x_up2))
        return x_up1, [x2, x4, x_up5, x_up3]
